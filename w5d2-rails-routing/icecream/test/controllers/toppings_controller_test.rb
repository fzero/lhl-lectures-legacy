...
class ToppingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create topping" do
    assert_difference('Topping.count') do
      post toppings_url, params: { topping: { flavour: @topping.flavour, ice_cream_id: @topping.ice_cream_id, type: @topping.type } }
    end
  ...
  test "should update topping" do
    patch topping_url(@topping), params: { topping: { flavour: @topping.flavour, ice_cream_id: @topping.ice_cream_id, type: @topping.type } }
