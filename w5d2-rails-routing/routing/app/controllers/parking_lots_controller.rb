class ParkingLotsController < ApplicationController
  ...
  before_action :set_parking_lot, only: [:show, :edit, :update, :destroy, :rate, :park]
  ...
  def search
    render text: "I'm /search!"
  end

  def rate
    render text: "#{@parking_lot.name} will be rated here"
  end
  ...
  private
    ...
    def parking_lot_params
      params.require(:parking_lot).permit(:name, :address, :lat, :lng, :size, :price, :rating)
    end
end
